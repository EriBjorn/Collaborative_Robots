...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.StartDemo3Btn.setText(_translate("MainWindow", "PushButton"))
        self.StopDemo3Btn.setText(_translate("MainWindow", "PushButton"))
        self.AboutLabel.setText(_translate("MainWindow", "About this project"))
        self.AboutTxt.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">This system was created by a group of automation engineering students at NTNU in Aalesund.<br/>The system was created as part of a project in the Mechatronics subject.<br/>The purpose of the project was to make the robots collaborate on a complex task, using vision and a force sensor.</span></p><p align=\"center\"><span style=\" font-size:18pt;\">The group consisted of the following students:<br/>Isak Gamnes Sneltvedt<br/>Erik Bjørnøy<br/>Erlend Holseker<br/>Arvin Khodabandeh</span></p><p align=\"center\"><span style=\" font-size:18pt;\">The collaborative robots in the Manulab are delivered by Omron.</span></p><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">This HMI is powered by Python.</span></p></body></html>"))
import Logo_rc
